...
public class TrackReaderTest {
    ...
    public ArrayList<Track> readTrack() throws FileNotFoundException {
        ...
        System.out.println("aaaaaaaa" + trackObjects.getTrackArrayList());
        return trackObjects.getTrackArrayList();
    }
